...
exports.parseVlessNode = void 0;
const base_1 = require("./base");
const parseVlessNode = (node, index) => {
    ...
    const allowInsecure = (0, base_1.toBoolean)(params.get('allowInsecure'));
    ...
    if (security === 'tls' || security === 'reality') {
        outbound.tls = {
            enabled: true,
            insecure: (0, base_1.toBoolean)(insecure),
            alpn: ['http/1.1'],
...
exports.parseVlessNode = parseVlessNode;
//# sourceMappingURL=parse-vless-node.js.map